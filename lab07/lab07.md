...
- Порт отправки (порт клиента) - 38982
- Порт приёма (порт сервера) - 80
...
- Sequence numeber - 478398433
- SYN определяется по флагу в заголовке TCP. 0x002 (SYN)
...
- Sequence numeber у SYNACK-сегмента - 2351142419
- Значение в поле подтверждения в SYNACK-сегменте - 478398434
- Acknowledgment Number — это SeqNumber из SYN сообщения + 1
- SYNACK определяется по флагам SYN и ACK
...
- Sequence Number этого TCP-сегмента - 478550474
...
**Первый сегмент - 2732 номер пакета**

| Номер пакета | Sequence Number | Время отправки     | Время ACK          | RTT             |
|--------------|-----------------|--------------------|--------------------|-----------------|
| 2732         | 478398434       | 14:24:08.230070863 | 14:24:08.338114893 | 0,10804403 сек  |
| 2733         | 478401330       | 14:24:08.230082847 | 14:24:08.338117210 | 0,108034363 сек |
| 2734         | 478404226       | 14:24:08.230086646 | 14:24:08.338117239 | 0,108030593 сек |
| 2735         | 478407122       | 14:24:08.230090327 | 14:24:08.338162780 | 0,108072453 сек |
| 2736         | 478410018       | 14:24:08.230095070 | 14:24:08.338280282 | 0,108185212 сек |
| 2738         | 478412914       | 14:24:08.338138420 | 14:24:08.338308134 | 0,000169714 сек |
...
Пропускная способность = (объем данных) / (время передачи).

![images/img_5.png](images/img_5.png)

объем данных = 152886 байт

Время передачи = 14:24:08.122007022 (2729 пакет) - 14:24:08.664969665 (2896 пакет HTTP Resp) = 0,542962643 сек

Пропускная способность = 152886 / 0,542962643 = 281577 байт/сек
