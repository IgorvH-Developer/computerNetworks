...
class LinuxStyleTraceroute:
    ...
    def create_udp_packet(self, size=28):
        return b'\x00' * size
    ...
    def trace(self, dest_addr, max_hops=30, timeout=1.0, num_probes=3):
...
if __name__ == '__main__':
    ...
    tracer = LinuxStyleTraceroute()

    try:
        tracer.trace(args.host, args.max_hops, args.timeout, args.num_probes)
    except Exception as e:
        print(f"traceroute: error occurred - {str(e)}")