...
1) Запускаем прокси-сервер

![images/img.png](images/img.png)

2) Отправляем запрос с браузера

![images/img_1.png](images/img_1.png)

3) Лог запросов прокси-сервера

![images/img_2.png](images/img_2.png)

4) Обработка POST запроса

<img alt="images/img_3.png" height="350" src="images/img_3.png" width="500"/>
...
Отправляем запрос, отсутствующий в кэше.

![images/img_4.png](images/img_4.png)

Отправляем тот же запрос снова
...
1) Содержимое чёрного списка

![images/img_6.png](images/img_6.png)

2) Отправляем запрос на разрешённый адрес

![images/img_7.png](images/img_7.png)

3) Отправляем запрос на запрещённый адрес
