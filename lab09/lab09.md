...
Мой адрес - 172.30.245.197

Адрес хоста назначения - 64.233.161.102

2. Почему ICMP-пакет не обладает номерами исходного и конечного портов?

ICMP работает на сетевом уровне (L3), а не транспортном (L4), где работают TCP/UDP.
...
4. Есть ли такой канал, задержка в котором существенно превышает среднее значение? Можете
   ли вы, опираясь на имена маршрутизаторов, определить м+естоположение двух маршрутизаторов,
...
1. Запускаем приложение и смотрим вывод в консоль
...
1. Запускаем приложение с параметрами (ip-адрес, стартовый порт, конечный порт) и смотрим вывод в консоль
