...
1) Запускаем клиент и сервер на порту 12345
...
Сразу начинается отправка клиентом файла alice.txt размером 148 КБайт. Передача заняла больше 3-ёх минут времени.
Передача проходила пакетами по 1024 байта (2 - seq num, 2 - check sum, 1020 - данные)

Дамп передачи файла сохранён в файле `dumps/alice_transporting.pcap`. Вот его часть:

![images/img.png](images/img.png)

Клиент отправлял файл alice.txt, а сервер сохранил полученный файл в uploads:
...
Клиент отправляет запрос на получение файла и ожидает отправку его с сервера. Клиент сохраняет полученный файл в папку downloads:

![images/img_6.png](images/img_6.png)

Дамп обмена сохранён в `dumps/server-client_transport.pcapng`. Вот его скриншот:
